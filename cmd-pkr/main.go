...
import (
	...
	"github.com/easylab-platform/pkr/pkrkit"
	"github.com/easylab-platform/pkr/pkrkit/store"
	_ "github.com/easylab-platform/pkr/cmd-pkr/adapters" // registers all enabled protocols
)
